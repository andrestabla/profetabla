            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="col-span-2">
                        <label className="block text-sm font-bold text-slate-700 mb-2">GIF de Carga (Platform Loader)</label>
                        <input name="loadingUrl" defaultValue={config?.loadingUrl || 'https://profetabla.s3.us-east-1.amazonaws.com/coaching.gif'} placeholder="https://ejemplo.com/loader.gif" className="w-full px-4 py-2 border rounded-lg" />
                        <p className="text-[10px] text-slate-400 mt-1 italic">Este GIF se mostrará durante las transiciones y estados de espera.</p>
                    </div>
                    <div className="col-span-2">
